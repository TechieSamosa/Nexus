...
export default function Transmissions({ posts }: { posts: BlogPost[] }) {
  ...
  return (
    <section id="transmissions" className="py-24 px-6 relative z-10 bg-space-900 border-t border-space-700">
              ...
              <Link href={`/transmissions/${post.slug}`} className="block h-full outline-none">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="text-xl font-bold text-white mb-3 group-hover:text-neon-cyan transition-colors">{post.title}</h3>
                  ...
                  <div className="relative z-10 flex items-center justify-between border-t border-space-700/50 pt-4 mt-auto">
                    <span className="text-xs font-mono text-neon-purple group-hover:text-white transition-colors">Read Log</span>
